...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('admin.order.index')}}" class="nav-link">Quản lí đơn đặt hàng</a>
      </li>
    </ul>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('category.themmoi')}}" class="nav-link">
...
<script src="{{url('public/admin')}}/plugins/toastr/toastr.min.css"></script>
<!-- AdminLTE App -->
...
@if(Session::has('yes'))
<script>
  toastr.success("{{Session::get('yes')}}",'Success', {timeOut: 3000})
</script>
@endif
