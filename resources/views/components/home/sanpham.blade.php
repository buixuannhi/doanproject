         ...
         <div class="card">
           <div class="cart-header">
            ...
            @foreach($cats as $cat)
               ...
               <a href="{{route('home.category', ['id' => $cat->id, 'slug' => Str::slug($cat->name)])}}">{{$cat->name}}</a>
         ...
         <div class="row">
            @foreach($products as $model)
               <div class="col-md-3 mt-5" style="border-bottom: 5px solid #f3f3f3 !important;  border-right: 5px solid #f3f3f3 !important; padding: 10px 15px 20px; overflow: hidden;">
                  <a href="{{route('home.product', ['id' => $model->id, 'slug' => Str::slug($model->name)])}}" >
                  ...
                  <div style="padding-top: 12px;text-decoration: line-through; color:#7d7d7d">
                     <b>{{$model->price}}  <s style="text-decoration: underline; font-size: 12px;">đ</s></b>
                  </div>
